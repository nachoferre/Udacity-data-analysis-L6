...
plot1 <- qplot(diamonds$price, geom="histogram", binwidth = 100, fill = I('#099DD9')) + 
  ggtitle('Price')

plot2 <- qplot(diamonds$price, geom="histogram", binwidth = 0.01, fill = I('#F79420')) +
  ggtitle('Price (log10)') +
  scale_x_log10()
...
modelEstimate
#exp gets the expected price of a diamond 
exp(modelEstimate)
```
